...
<body id="page-top">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item ">
        <a class="nav-link" href="/mahasiswa/SuratKeterangan">
        <i class="fas fa-fw fa-file"></i>
        <span>Surat Keterangan</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="/mahasiswa/PraKp">
        <i class="fas fa-fw fa-file"></i>
        <span>Pra KP</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="/mahasiswa/Kp">
        <i class="fas fa-fw fa-book"></i>
        <span>KP</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="/mahasiswa/jadwalUjian">
        <i class="fas fa-fw fa-book"></i>
